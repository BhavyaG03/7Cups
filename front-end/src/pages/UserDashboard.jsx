    ...
    <div className="min-h-screen bg-[#f8fafc] w-full px-4 py-8" style={{ fontFamily: 'Epilogue, sans-serif' }}>
      <div className="w-full max-w-5xl mx-auto">
        ...
        <div className="flex flex-col items-center gap-4 mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-center mt-2">Welcome back, {username}</h1>
          ...
          <img src="/a1.png" alt="Focus" className="w-full max-w-md h-36 sm:h-40 object-cover rounded-xl shadow" />
        </div>
        {/* Progress Card */}
        <div className="mb-8">
          <div className="font-semibold text-lg mb-3">Your Progress</div>
          <div className="bg-white rounded-2xl shadow border border-gray-200 p-0 overflow-hidden max-w-md mx-auto">
        ...
        <div className="mb-8 max-w-md mx-auto">
          ...
          <button
            className="w-full bg-[#e5e8ef] text-gray-900 font-semibold rounded-full px-5 py-3 shadow-sm hover:bg-[#d3e3ed] transition text-base mb-4"
        ...
        {/* Recommended for You - Carousel on mobile */}
        <div className="mb-4">
